...
<div class="row">
    <div class="col-md-12">
        <div class="card card-custom">
            ...
            <div class="card-body">
                {!! Form::model(Request::all(),['route'=> ['comprobantes.fiscales.update'],'onsubmit' => "return validacion_form()"]) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            {{Form::text('fecha_2',\Carbon\Carbon::parse($comprobante->fecha)->format('d/m/Y'),['disabled'=>true,'class'=>'form-control form-control-sm font-verdana-bg', 'id' => 'fecha','data-language' => 'es', 'placeholder' => 'dd/mm/yyyy', 'autocomplete' => 'off', 'onkeyup' => 'countChars(this);'])}}
                        ...
                        <div class="col-md-2">
                            ...
                            {!! Form::select('tipo_2', array('1'=>'INGRESO','2'=>'EGRESO','3'=>'TRASPASO'), $comprobante->tipo, ['disabled'=>true,'placeholder' => '--Seleccionar--','class' => 'form-control form-control-sm ' . ( $errors->has('tipo') ? ' is-invalid' : '' ),'id' => 'tipo']) !!}
