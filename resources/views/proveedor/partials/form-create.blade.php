<div class="form-group row">
    <div class="col-md-4">
        ...
        {{Form::text('razon_social',null,['id' => 'razon_social','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('razon_social') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeyup' => 'copiarRazonSocial(this);'])}}
    ...
    <div class="col-md-4">
        ...
        <font color="red">&nbsp;<i class="fas fa-asterisk fa-xs"></i></font>
        {{Form::text('nombre_comercial',null,['id' => 'nombre_comercial','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('nombre_comercial') ? ' is-invalid' : '' ),'autocomplete'=>'off'])}}
    ...
    <div class="col-md-2">
        ...
        <font color="red">&nbsp;<i class="fas fa-asterisk fa-xs"></i></font>
        {{Form::text('nit',null,['id' => 'nit','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('nit') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-2">
        ...
        <font color="red">&nbsp;<i class="fas fa-asterisk fa-xs"></i></font>
        {!! Form::select('ciudad',$ciudades,null, ['placeholder' => '--Seleccionar--','class' => 'form-control form-control-sm select2' . ( $errors->has('ciudad') ? ' is-invalid' : '' ),'id'=>'ciudades']) !!}
...
<div class="form-group row">
    <div class="col-md-2">
        ...
        {!! Form::select('tipo',array('MATERIAL' => 'MATERIAL',
                                        ...
                                        'CREDITO' => 'CREDITO',
                                        'REPUESTO' => 'REPUESTO',
                                        'VARIOS' => 'VARIOS'),null, ['placeholder' => '--Seleccionar--','class' => 'form-control form-control-sm select2' . ( $errors->has('tipo') ? ' is-invalid' : '' ),'id'=>'tipo']) !!}
    ...
    <div class="col-md-3">
        ...
        {{Form::text('nro_cuenta',null,['id' => 'nro_cuenta','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('nro_cuenta') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-4">
        ...
        {{Form::text('titular_cuenta',null,['id' => 'titular_cuenta','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('titular_cuenta') ? ' is-invalid' : '' ),'autocomplete'=>'off'])}}
    ...
    <div class="col-md-3">
        ...
        {{Form::text('banco',null,['id' => 'banco','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('banco') ? ' is-invalid' : '' ),'autocomplete'=>'off'])}}
    ...
    <div class="col-md-6">
        ...
        <font color="red">&nbsp;<i class="fas fa-asterisk fa-xs"></i></font>
        {{Form::text('direccion',null,['id' => 'direccion','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('direccion') ? ' is-invalid' : '' ),'autocomplete'=>'off'])}}
    ...
    <div class="col-md-4">
        ...
        {{Form::text('email',null,['id' => 'email','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('email') ? ' is-invalid' : '' ),'autocomplete'=>'off'])}}
    ...
    <div class="col-md-4">
        ...
        {{Form::text('contacto_1',null,['id' => 'contacto_1','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('contacto_1') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-3">
        ...
        {{Form::text('celular_1',null,['id' => 'celular_1','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('celular_1') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-3">
        ...
        {{Form::text('fijo_1',null,['id' => 'fijo_1','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('fijo_1') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-4">
        ...
        {{Form::text('contacto_2',null,['id' => 'contacto_2','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('contacto_2') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-3">
        ...
        {{Form::text('celular_2',null,['id' => 'celular_2','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('celular_2') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-3">
        ...
        {{Form::text('fijo_2',null,['id' => 'fijo_2','class'=>'form-control form-control-sm font-verdana-bg' . ( $errors->has('fijo_2') ? ' is-invalid' : '' ),'autocomplete'=>'off','onkeypress' => 'return valideKey(event);'])}}
    ...
    <div class="col-md-8">
        ...
        {{ Form::textarea('observaciones',null,['class'=>'form-control form-control-sm font-verdana-bg'. ( $errors->has('observaciones') ? ' is-invalid' : '' ),'rows' => 1]) }}
