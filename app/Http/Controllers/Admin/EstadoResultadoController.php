...
class EstadoResultadoController extends Controller
{
    ...
    public function excel(Request $request){
        ...
        $nroMaxColumna = 5;
        $total = $totales[$ingresos[0]->id] - $totales[$costos[0]->id] - $totales[$gastos[0]->id];
        $file_name = 'EstadoResultado';
        return Excel::download(new EstadoResultadoExport($ingresos,$costos,$gastos,$totales,$cuentas,$proyecto,$start_date,$end_date,$status_text,$nroMaxColumna,$total),$file_name . '.xlsx');
    }
