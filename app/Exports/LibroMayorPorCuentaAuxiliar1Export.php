...
class LibroMayorPorCuentaAuxiliar1Export implements FromView,ShouldAutoSize
{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro-mayor.por-cuenta.excel.auxiliarExcel',compact('fecha_saldo_inicial','proyecto','tipo','plancuenta','fecha_inicial','fecha_final','auxiliares'));
    }
}
