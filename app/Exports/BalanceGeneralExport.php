...
class BalanceGeneralExport implements FromView,ShouldAutoSize
{
    ...
    public function view(): view{
        ...
        return view('balance-general.excel',compact('activos','pasivos','patrimonios','cuentas','totales','proyecto','start_date','end_date','status_text','nroMaxColumna','total_activo','total_capital_pasivo'));
    }
}
