...
<div class="form-group row font-verdana-bg">
    <div class="col-md-12 text-right">
        <span class="tts:left tts-slideIn tts-custom/ font-verdana" aria-label="Retroceder">
            <a href="{{route('libromayor.de1a99.index')}}" class="btn btn-sm btn-primary font-verdana-bg" onclick="hide();">
                <i class="fas fa-angle-double-left"></i>
            </a>
        </span>
        <span class="tts:left tts-slideIn tts-custom/ font-verdana" aria-label="Exportar a Excel">
            <a href="{{ route('libromayor.de1a99.excel',['dat1' => $proyecto->id,'dat2' => $fecha_inicial,'dat3' => $fecha_final,'dat4' => $estado,'dat5' => $plancuenta_inicial->id,'dat6' => $plancuenta_final->id]) }}" class="btn btn-sm btn-success font-verdana-bg" onclick="hide();">
                <i class="fas fa-file-excel"></i>
            </a>
        </span>
        <span class="tts:left tts-slideIn tts-custom/ font-verdana" aria-label="Exportar a Pdf">
            <a href="{{ route('libromayor.de1a99.pdf',['dat1' => $proyecto->id,'dat2' => $fecha_inicial,'dat3' => $fecha_final,'dat4' => $estado,'dat5' => $plancuenta_inicial->id,'dat6' => $plancuenta_final->id]) }}" class="btn btn-sm btn-danger font-verdana-bg" target="blank" onclick="hide();">
