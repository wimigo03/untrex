...
class ComprobantesFiscalesDetalleController extends Controller
{
    ...
    public function create(ComprobantesFiscales $comprobante){
        ...
        return view('comprobantes-fiscales-detalles.create',compact('comprobante','user','socio','proyectos','centros','plan_cuentas','plan_cuentas_auxiliares','comprobante_detalle','total_debe','total_haber'));
    }
    ...
    public function editar($comprobante_detalle_id){
        ...
        return view('comprobantes-fiscales-detalles.editar',compact('comprobante_detalle','comprobante','user','socio','proyectos','centros','plan_cuentas','plan_cuentas_auxiliares','comprobante_detalles','total_debe','total_haber'));
    }
