    ...
    <div class="col-md-12">
        <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                @include('libro-diario.partials.encabezado')
                @include('libro-diario.partials.table')
            </div>
        </div>
    </div>
</div>
...
@section('js')
    <script>
        function limpiar(){
            ...
            $(".btn-importar").hide();
            $(".spinner-btn").show();
            window.location.href = "{{ route('librodiario.index') }}";
        }

        function excel(){
            var url = "{{ route('librodiario.excel') }}";
