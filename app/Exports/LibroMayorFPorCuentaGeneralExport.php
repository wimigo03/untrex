...
class LibroMayorFPorCuentaGeneralExport implements FromView,ShouldAutoSize
{
    use Exportable;
    ...
    public function view(): view{
        ...
        return view('libro-mayor-f.por-cuenta.excel.GeneralExcel',compact('proyecto','tipo','plancuenta','fecha_inicial','fecha_final','comprobantes','saldo','saldo_final','total_debe','total_haber'));
    }
}
