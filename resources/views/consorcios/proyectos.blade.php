    ...
    <div class="col-md-12">
        <div class="card card-custom">
            <div class="card-header bg-gradient-secondary text-white">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card-title"><b>PROYECTOS</b></div>
                    </div>
                    <div class="col-md-2 text-right">
                        <a href="{{--route('consorcio.create')--}}" class="text-white">
                                        ...
                                        <table id="dataTable" class="display responsive" style="width:80%">
                                            <thead>
                                                <tr class="font-verdana">
                                                    ...
                                                    <td class="text-center p-1"><b>ABREVIATURA</b></td>
                                                    <td class="text-center p-1"><b>UBICACION</b></td>
                                            ...
                                            <tbody>
                                                @foreach ($proyectos as $datos)
                                                    <tr class="font-verdana">
                                                        ...
                                                        <td class="text-center p-1">{{$datos->ubicacion}}</td>
