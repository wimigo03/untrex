...
use App\Exports\LibroMayorDe1a99Export;
class LibroMayorDe1a99Controller extends Controller
{
    public function index(){
        $proyectos = Proyectos::pluck('nombre','id');
        return view('libro-mayor.de-1-a-99.index',compact('proyectos'));
    }
    ...
    public function search(Request $request){
        ...
        return view('libro-mayor.de-1-a-99.search',compact('proyecto','plancuenta_inicial','plancuenta_final','comprobantes','fecha_inicial','fecha_final','total_debe','total_haber','estado'));
    }
    ...
    public function pdf($proyecto,$fecha_inicial,$fecha_final,$estado,$plancuenta_inicial_id,$plancuenta_final_id){
        ...
        try{
            ...
            $pdf = PDF::loadView('libro-mayor.de-1-a-99.pdf',compact(['proyecto','plancuenta_inicial','plancuenta_final','comprobantes','fecha_inicial','fecha_final','total_debe','total_haber','estado']));
    ...
    public function excel($proyecto,$fecha_inicial,$fecha_final,$estado,$plancuenta_inicial_id,$plancuenta_final_id){
        ...
        return Excel::download(new LibroMayorDe1a99Export($proyecto,$plancuenta_inicial,$plancuenta_final,$comprobantes,$fecha_inicial,$fecha_final,$total_debe,$total_haber,$estado),$file_name . '.xlsx');
    }
}
