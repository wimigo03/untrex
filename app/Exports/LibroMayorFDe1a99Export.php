...
class LibroMayorFDe1a99Export implements FromView,ShouldAutoSize
{
    use Exportable;
    ...
    public function view(): view{
        ...
        $estado = $this->estado;
        return view('libro-mayor-f.de-1-a-99.excel',compact('proyecto','plancuenta_inicial','plancuenta_final','comprobantes','fecha_inicial','fecha_final','total_debe','total_haber','estado'));
    }
}
